...
export default class FeedbackView extends Component{
    ...
    onDelete =(id) =>{
        axios.delete(`http://localhost:8070/feedback/fbdelete/${id}`).then((res)=>{
            alert("Delete Feedbacks Succesfully !!");
    ...
    render(){
        ...
        return(
            ...
            <div>
                ...
                <h1 className='header-name'>All received  Feedback  details On all sections in Institute</h1><br/>
         ...
         <b style={{fontSize:20}}>You can Generate the ReportClicking This Button :</b>
         <button className="btn btn-success" style={{marginLeft:100}}><a class="caption-helper btn btn-round" href={`/dashboard/printview`} style={{color:"white"}}><b> GENERATE REPORT</b></a></button>
