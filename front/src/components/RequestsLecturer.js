...
export default class RequestsLecturer extends Component{
    constructor(props){
        super(props);
            ...
            <div className="container">
                <div className="row">
                    <div className="col-lg-9 mt-2 mb-2">
                        <h4 className='header-name'>All Lecturer Requests</h4>
                    </div>
                        ...
                        {this.state.lecturers.map((lecturers,index) =>(
                            <tr key={index}>
                                <th scope="row">{index+1}</th>
                                    ...
                                    <td>
                                        <a className="btn btn-warning" href={`/dashboard/editlecture/${lecturers._id}`}>
