...
export default class NoticeUpdate extends Component{
  ...
  componentDidMount(){
   ...
   <div style={{backgroundColor:"#DCE0DD" , height:1000}}>
          
        <h1 className='header-name' style={{marginLeft:480}}> <u> To Upadte The Notices</u>   </h1>
                              ...
                              <div className="row">
                                <div class="col-md-30">
                                  <div>
                                          ...
                                          <div class="mb-3">
                                          <button type="button" class="btn btn-success"  onClick={this.onSubmit}> UPDATE  </button>
                                          </div>
                                          ...
                                          <br></br><br></br>
                                            ...
                                            <br></br>
                                              ...
                                              <div className="col-md-12">
                                                  <button type="submit" className="vnote" value="UPDATE"><a href={`/dashboard/feedAdminview`} style={{color:"white"}}>View Updated Notices</a> </button>
                                                </div>
