...
export default class EditStudent extends Component {
    ...
    onSubmit = (e) => {
        ...
        console.log(data)
        axios.put(`http://localhost:8070/students/update/${id}`,data).then((res) =>{
            if(res.data.success){
    ...
    componentDidMount(){
        ...
        axios.get(`http://localhost:8070/students/${id}`).then((res) =>{
            if(res.data.success) {
                this.setState({
                    firstname:res.data.students.firstname,
                    lastname:res.data.students.lastname,
                    dob:res.data.students. dob,
                    gender:res.data.students.gender,
                    address:res.data.students.address,
                    nic:res.data.students.nic,
                    email:res.data.students.email,
                    phoneno:res.data.students.phoneno,
                    hequalification:res.data.students.hequalification,
                    subject:res.data.students.subject
                });
    ...
    render() {
        ...
        <div className="col-md-8 mt-4 mx-auto">
            ...
            <h4 className="h3 mb-3 font-weight-normal header-name">Profile</h4>
