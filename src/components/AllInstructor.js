      ...
      <div className="container">
        <div className="row">
          <div className="col-lg-9 mt-2 mb-2">
            <h4 className='header-name'>All Instructors</h4>
          </div>
          ...
          <tbody>
            {this.state.instructors.map((instructors,index) =>(
              <tr key={index}>
                ...
                <td>
                  <a href={`/dashboard/instructor/${instructors._id}`} style={{textDecoration:'none'}}>
                ...
                <td>
                  <a className="btn btn-warning" href={`/dashboard/editrequest/${instructors._id}`}>
        ...
        <button className="btn btn-success"><a href="/dashboard/instructor-register" style={{textDecoration:'none', color:'white'}}>Add New Instructor</a></button>
        &nbsp;
        &nbsp;
        &nbsp;
        &nbsp;
        <button className="btn btn-success"><a href="/dashboard/reportgenerate" style={{textDecoration:'none', color:'white'}}>Generate Report</a></button>
        &nbsp;
        &nbsp;
        &nbsp;
        &nbsp;
